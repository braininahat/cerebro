...
class HBNDataModule(L.LightningDataModule):
    ...
    def __init__(
        ...
        if cache_dir is None:
            ...
            self.cache_dir = self.data_dir / "cache" / cache_subdir
        else:
    ...
    def _filter_datasets(self, datasets: BaseConcatDataset) -> BaseConcatDataset:
        ...
        filtered = Parallel(n_jobs=self.hparams.num_workers, backend='threading')(
